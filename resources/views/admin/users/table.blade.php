        ...
        <tr>
          ...
          <td>
            @if ($user->is_activated == 1)
              <input name="is_activated" class="activated_user" data-id="{{ $user->id }}" value="" type="checkbox"
                checked>
            @else
              <input name="is_activated" class="activated_user" data-id="{{ $user->id }}" type="checkbox">
            @endif
          </td>
          <td>
            {{ $user->created_at }}
