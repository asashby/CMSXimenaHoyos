      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route('questions.store') }}" name="createArticle" id="createArticle"
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="max_time" name="max_time"
                      placeholder="Ingrese Tiempo Maximo">
                  </div>
                  <div class="form-group">
                    <label for="title">Descanso entre Repeticiones</label>
                    <input type="number" class="form-control" id="time_rest" name="time_rest"
                      placeholder="Ingrese Tiempo Descanso">
                  </div>
                </div>
