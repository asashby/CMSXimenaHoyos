...
@section('content')
  <div class="content-wrapper">
    <x-position root="Home" title="Progreso de usuarios" position="Progreso de usuarios" url="{{ url('dashboard') }}" />
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <select style="width: 400px;" class="form-control selected-course" name="unit_id" id="course_id">
