      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ url('dashboard/recipes/edit/' . $recipeDetail->id) }}" name="editRecipe"
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select name="timefood" class="form-control select2" style="width: 100%;">
                      <option <?php if ($recipeDetail->time_food == 'Desayuno') {
                          echo 'selected="selected"';
                      } ?>>Desayuno</option>
                      <option <?php if ($recipeDetail->time_food == 'Media Mañana') {
                          echo 'selected="selected"';
                      } ?>>Media Mañana</option>
                      <option <?php if ($recipeDetail->time_food == 'Almuerzo') {
                          echo 'selected="selected"';
                      } ?>>Almuerzo</option>
                      <option <?php if ($recipeDetail->time_food == 'Media Tarde') {
                          echo 'selected="selected"';
                      } ?>>Media Tarde</option>
                      <option <?php if ($recipeDetail->time_food == 'Cena') {
                          echo 'selected="selected"';
                      }
                      ?>>Cena</option>
                    </select>
                      ...
                      <tbody>
                        @foreach ($recipeDetail->nutritional_facts as $macro)
                          <tr macro="{{ $macro->macro }}">
                            ...
                            <td>
                              <a href="javascript:void(0)" id="DeleteButton" style="cursor: pointer;" title="Eliminar"><i
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" onchange="preview_image(event)" name="recipeBanner"
                      id="recipeBanner">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" onchange="preview_image2(event)" name="recipeContent"
                      id="recipeContent">
                            ...
                            <div class="card card-primary collapsed-card">
                              <div class="card-header">
                                ...
                                <div class="card-tools">
                                  <a href="javascript:void(0)" id="deletestep" style="cursor: pointer;"
                                    title="Eliminar"><i style="color: red;" class="fas fa-trash-alt"></i></a>
