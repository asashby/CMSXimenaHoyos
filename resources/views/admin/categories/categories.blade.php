                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ url('dashboard/categories/create') }}"
                                ...
                                class="btn btn-block btn-success">Agregar Categorias</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="tooltip"
                                                href="{{ url('dashboard/categories/edit/'.$category->id) }}"
                                                title="Editar">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="confirmDelete" style="cursor: pointer;"
                                                record="category" recordId="{{ $category->id }}" data-toggle="tooltip"
                                                title="Eliminar">
