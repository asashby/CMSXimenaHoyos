          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ url('dashboard/tips/create') }}" style="max-width: 150px; float: right; display:inline-block;"
                  class="btn btn-block btn-success">Agregar Tip</a>
              </div>
                    ...
                    @foreach ($tips as $tip)
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="javascript:void(0)" class="confirmDelete" style="cursor: pointer;" record="tip"
                            recordId="{{ $tip->id }}" data-toggle="tooltip" title="Eliminar">
