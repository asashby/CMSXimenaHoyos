                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="articleTextLink" name="linkFb"
                                        value="{{$articleDetail->addittional_info->facebook}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" onchange="preview_image(event)"
                                        name="articleBanner" id="articleBanner">
                                    <img style="margin-top: 10px;" class="img-fluid" id="output_image"
                                        src="{{asset($articleDetail->banner)}}" />
                                    <input type="hidden" name="currentArticleBanner"
                                        value="{{ $articleDetail->banner }}">
                                </div>
                                <div class="form-group">
