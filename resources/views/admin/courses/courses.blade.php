                    ...
                    @foreach ($courses as $course)
                      <tr>
                        ...
                        <td>
                          ...
                          <a data-toggle="tooltip" href="{{ url('dashboard/courses/edit/' . $course->id) }}"
                            title="Editar">
                            <i class="far fa-edit"></i>
                          </a>
                          <a href="javascript:void(0)" class="confirmDelete" style="cursor: pointer;" record="course"
                            recordId="{{ $course->id }}" data-toggle="tooltip" title="Eliminar">
